...
> Answer: it will show output in console and any packages that might come with it.
...
> Answer: For time series analysis u don't remove NAs but for something like river temperature, you might want to keep the NA to know that there is no data there. 
